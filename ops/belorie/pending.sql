...
VALUES (
  49,10,
  'https://www.notino.es/cerave/cleansers-brightening-gel-limpiador-con-efecto-iluminador-con-vitamina-c/',
  (
    SELECT SUBSTR(affiliate_url,1,INSTR(affiliate_url,'url=')+3)
    FROM variant_offers
    WHERE retailer_id=10 AND affiliate_url IS NOT NULL
    ORDER BY id DESC LIMIT 1
  ) || 'https%3A%2F%2Fwww.notino.es%2Fcerave%2Fcleansers-brightening-gel-limpiador-con-efecto-iluminador-con-vitamina-c%2F',
  1,'verified','CEV02216',13.90,'EUR','in_stock',
  'Exact product and format: CeraVe Brightening Vitamin C Cleanser 236 ml',
  'manual','notino:exact:CEV02216:2026-09-25',
