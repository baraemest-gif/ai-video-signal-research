...
VALUES (
  52,
  7,
  'https://www.stylevana.com/es_ES/la-roche-posay-pure-vitamin-c12-serum-30ml108314.html',
  (
    ...
    ORDER BY id DESC
    LIMIT 1
  ) || 'https%3A%2F%2Fwww.stylevana.com%2Fes_ES%2Fla-roche-posay-pure-vitamin-c12-serum-30ml108314.html',
  1,
  'verified',
  NULL,
  40.69,
  'EUR',
  'in_stock',
  'Producto y formato exactos: La Roche-Posay Pure Vitamin C12 Serum 30 ml verificado en Stylevana España',
  'manual',
  'stylevana:exact:la-roche-posay-pure-vitamin-c12-30ml:2026-09-25',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
)
